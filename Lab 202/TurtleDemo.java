...
public class TurtleDemo {
    ...
    private static Turtle[] turtles = {
        new VeeringTurtle(110.0),
        new VeeringTurtleDecorator(new HandDrawnTurtle(), 80.0),
        new RainbowTurtle(),
        new RainbowTurtleDecorator(new VeeringTurtleDecorator(new CurveTurtle(), 80.0)),
        new SkippingTurtle(4),
        new SkippingTurtleDecorator(new AntennaTurtle(new BasicTurtle(), 15), 2)
